...
def send_mail_task():
    ...
    worksheet.merge_range('A2:E2', "From date : 2021-07-12 00:00:01", merge_info)
    worksheet.merge_range('A3:E3', 'To date : 2021-07-18 23:59:59', merge_info)
